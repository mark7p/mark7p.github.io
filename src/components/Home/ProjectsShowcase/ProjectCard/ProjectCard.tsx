...
export default function ProjectCard({project}: { project: ProjectCardProps }) {
    return (
        <div className="project-card flex gap-5 p-5 rounded-lg  hover:text-custom-teal-100 hover:bg-custom-teal-300/20 mb-3 hover:cursor-pointer select-none flex-wrap">
